...
namespace UsersManagementService.Repositories
{
    public interface ITaskRepository
    {
        ...
        Task<ResponseModel> AddorUpdateTasks(ResponseTaskMain responseTaskMain, string? username);
        ...
        Task<ResponseModel> UpdateTaskBoardNew(updateTaskMngrModel task, string? username);
        void SendMailsforAutoTask();
    }
}
