...
namespace UsersManagementService.Services
{
    public class TaskService: ITaskService
    {
        ...
        {
            return taskRepository.GetAllTasks(userName,searchQuery, view, status, taskType, sprint, priority, natureOfTask, pageNo);
        }
		/*
		public ResponseModel GetAllTasks(string? userName,string? searchQuery = null, string? view = null, string? status = null, string? taskType = null,
		...
		*/
        ...
        {
            return await taskRepository.AddorUpdateTasks(responseTaskMain, username);
        }
        ...
        {
            return await taskRepository.UpdateTaskBoardNew(task, username);
        }
