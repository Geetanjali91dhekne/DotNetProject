...
namespace KpiAnalyzerService.Controllers
{
    ...
    public class AnalyzerController : Controller
    {
        ...
        public IActionResult GetDataFilterConditions(string tableName, string? filterColumns = null)
        {
            try
            {
                var response = context.GetDataFilterConditions(tableName, filterColumns);
                if (response != null)
                {
                    //_logger.LogError("task found");
                }
